...
it("e2e", async () => {
  ...
  serverMock
    .onPost("/api/v1/policy/resolve?userName=some-user&host=some-host&path=some-path", {
      updates: {
        retention: {
          keepLatest: 33,
        },
  ...
  await waitFor(() =>
    expect(getByTestId("definition-retention.keepMonthly").innerHTML).toContain("Directory: u1@h1:p1"),
  );
