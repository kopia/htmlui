...
export class EmailNotificationMethod extends Component {
    ...
    validate() {
        if (!validateRequiredFields(this, ["smtpServer","smtpPort", "smtpUsername", "smtpPassword", "from", "to"])) {
            return false;
        }
    ...
    render() {
        return <>
            <Row>
                {RequiredField(this, "SMTP Server", "smtpServer", { autoFocus: true, placeholder: "SMTP server DNS name, e.g. smtp.gmail.com" })}
            ...
            <Row>
                {RequiredField(this, "Mail From", "from", { placeholder: "sender email address" })}
                {RequiredField(this, "Mail To", "to", { placeholder: "reipient email addresses, comma-separated" })}
                {OptionalField(this, "CC", "cc", { placeholder: "CC addresses (comma-separated)" })}
