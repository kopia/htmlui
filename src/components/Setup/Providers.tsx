...
export const supportedProviders: Provider[] = [
    ...
    { name: "gcs", description: "Google Cloud Storage", isInternal: false, render: (self) => <SetupGCS provider={self} /> },
    { name: "s3", description: "Amazon S3 or Compatible Storage", isInternal: false, render: (self) => <SetupS3 provider={self} /> },
    { name: "b2", description: "Backblaze B2", isInternal: false, render: (self) => <SetupB2 provider={self} /> },
    { name: "azureBlob", description: "Azure Blob Storage", isInternal: false, render: (self) => <SetupAzure provider={self} /> },
    { name: "sftp", description: "SFTP Server", isInternal: false, render: (self) => <SetupSFTP provider={self} /> },
    { name: "rclone", description: "Rclone Remote", isInternal: false, render: (self) => <SetupRclone provider={self} /> },
    { name: "webdav", description: "WebDAV Server", isInternal: false, render: (self) => <SetupWebDAV provider={self} /> },
